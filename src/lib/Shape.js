...
class Cell {
  ...
  rotate(center, clockwise) {
    const dx1 = this.x + 0.5 - center.x,
      dy1 = this.y + 0.5 - center.y;
...
const shapes = [
  {
    color: "#00f0f0",
    cells: [new Cell(0, 0), new Cell(1, 0), new Cell(2, 0), new Cell(3, 0)]
  },
  {
    color: "#f0f000",
  ...
  {
    color: "#a000f0",
    cells: [new Cell(1, 0), new Cell(0, 1), new Cell(1, 1), new Cell(2, 1)]
  },
  {
    color: "#0000f0",
    cells: [new Cell(0, 0), new Cell(0, 1), new Cell(1, 1), new Cell(2, 1)]
  },
  {
    color: "#00f000",
    cells: [new Cell(1, 0), new Cell(2, 0), new Cell(0, 1), new Cell(1, 1)]
  },
  {
    color: "#f0a000",
    cells: [new Cell(2, 0), new Cell(0, 1), new Cell(1, 1), new Cell(2, 1)]
  },
  {
    color: "#f00000",
    cells: [new Cell(0, 0), new Cell(1, 0), new Cell(1, 1), new Cell(2, 1)]
  }
];
...
class Shape {
  ...
  createRandomShape() {
    ...
    this.pos = new Cell(Math.floor(fieldSize.width / 2 - width / 2), -height);
